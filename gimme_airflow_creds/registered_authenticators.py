...
class RegisteredAuthenticators(object):
    """
       The RegisteredAuthenticators class manages a json file of gimme-airflow-creds registered
       FIDO authenticators.
    ...
    def get_authenticator_user(self, credential_id):
        ...
        :type credential_id: bytes
        :return: user identifier, if credential id was registered by gimme-airflow-creds, or None
        :rtype: str
        """
        authenticators = self._get_authenticators()
