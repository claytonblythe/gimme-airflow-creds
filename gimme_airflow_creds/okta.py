...
class OktaClient(object):
    ...
    KEYRING_SERVICE = 'gimme-airflow-creds'
    ...
    def _get_headers():
        ...
        headers = {
            'User-Agent': "gimme-airflow-creds {}".format(version),
    ...
    def _activate_webauthn_factor(self, state_token):
        ...
        return attestation.auth_data.credential_data.credential_id, user_obj.get('name', 'gimme-airflow-creds')
